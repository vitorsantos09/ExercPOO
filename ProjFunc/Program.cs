...
{   
            ...
            case 1:
                   Console.WriteLine("==========================================");
                    ...
                    Console.WriteLine("3. Funcionario Temporario");
                        ...
                        CadastroPad(out string nome, out string cpf, out string cargo, out double salarioBruto); //Declara as variaveis e faz a chamada no out para serem preenchidas no Metodo e retornarem para essa chamada
                        if(opCad == 3){
    ...
    static void CadastroPad(out string nome,out string cpf,out string cargo, out double salarioBruto)
{
    Console.WriteLine("==========================================");
